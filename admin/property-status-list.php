                        ...
                        <div class="card-body">
                            <table id="datatable-buttons"
                                ...
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Property Status Name</th>
                                        <th>Property Status Slug</th>
                                ...
                                <tbody>
                                    <?php 
                              foreach($connect->query("SELECT * FROM property_status ORDER BY id DESC") as $list){ 
                             ?>
                                    <tr>
                                        <td><?=$list['id']?> </td>
                                        <td><?=$list['status_name']?> </td>
                                        <td><?=$list['status_slug']?></td>
                                        ...
                                        <td class="d-flex justify-content-center">
                                            <form action="edit-property-status.php" method="post">
                                                <input type="hidden" name="psid" value="<?=$list['id']?>" />
                                                <button class="btn btn-success mx-1" name="ps_edit_btn" type="submit"><i
                                                        class="bx bx-edit"></i> Edit</button>
                                            </form>
                                            <form action="function_code/property-status-function.php" method="post">
                                                <input type="hidden" name="psid" value="<?=$list['id']?>" />
