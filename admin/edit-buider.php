         ...
         <div class="card-body">
            ...
            <form method="post" action="function_code/builder-function.php" enctype="multipart/form-data">
               <div class="row">
                  <div class="col-md-6">
                     <div class="mb-3">
                         <input type="text" name="blid" value="<?= $$builder['id']?>" hidden>
                  ...
                  <div class="col-md-6">
                     <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="slug" name="builder_slug" value="<?= $builder['bldr_slug']?>" placeholder="Enter Bulder Slug">
                     </div>
                  </div>
                  <div class="col-sm-6">
                     <div class="mb-3">
                        ...
                        <input class="form-contro sdsdl"  type="file" name="builderlogo_main" value="<?= $builder['bldr_logo']?>" hidden id="image-input1" >
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
