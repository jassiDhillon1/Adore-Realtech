      ...
      <div class="card">
         <div class="card-body">
            ...
            <form method="post" action="function_code/location-function.php" enctype="multipart/form-data">
               <div class="row">
                  <div class="col-md-6">
                     <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="title" name="location_name" placeholder="Enter Your Location Title" required>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="mb-3">
                        <label for="formrow-lastname-input" class="form-label">Location Slug</label>
                        <input type="text" class="form-control" id="slug" name="location_slug" placeholder="Enter Location Slug">
                     </div>
                  </div>
                  <div class="col-sm-6">
                     <div class="mb-3">
               ...
               <div>
                  <button type="submit" name="location_submit" class="btn btn-primary w-md">Submit</button>
               </div>
            </form>
         </div>
         <!-- end card body -->
