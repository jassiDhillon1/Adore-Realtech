...
<div class="page-content">
   <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
               <h4 class="mb-sm-0 font-size-18">Popup Document List</h4>
               <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                     <li class="breadcrumb-item"><a href="javascript: void(0);">Popup Floor List</a></li>
      ...
      <div class="row">
         <div class="col-12"> 
            <div class="card p-3">
                <form method="post" class="mt-4" action="function_code/pop-function.php" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <input class="form-control" type="text" hidden name="pop_id" value="<?= $_GET['poid'] ?>" placeholder="Enter Document Name">
                            </div>
                            <div class="col-sm-6">
               ...
               <div class="card-body">
                  <table id="datatable-buttons" 
                     ...
                     <tbody>
                        ...
                        $i = 1;
                           foreach($connect->query("SELECT * FROM `home_popup_document` WHERE popup_id='$pdid'") as $list){ 
                        ...
                        <tr>
                           ...
                           <td class="d-flex justify-content-center">
                              <form action="function_code/pop-function.php" method="post">
                                 <input type="hidden" name="pdid" value="<?=$list['pd_id']?>" />
