...
<div class="row">
   <div class="col-12">
      <div class="page-title-box d-sm-flex align-items-center justify-content-between">
         <h4 class="mb-sm-0 font-size-18">Add  Property Specification</h4>
...
<div class="row">
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title mb-4">Create Property Specification</h4>
            <form method="post" action="function_code/property-spec-function.php" enctype="multipart/form-data">
               <div class="row">
                  <div class="col-md-6">
                     <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="title" name="prop_spec_name" placeholder="Enter Your Property Spec Title" required>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="mb-3">
                        <label for="formrow-lastname-input" class="form-label">Property Specification Slug</label>
                        <input type="text" class="form-control" id="slug" name="prop_spec_slug" placeholder="Enter Property Status Slug">
                     </div>
                  </div>
                  <div class="col-sm-6">
                     <div class="mb-3">
               ...
               <div>
                  <button type="submit" name="prop_spec_submit" class="btn btn-primary w-md">Submit</button>
               </div>
            </form>
         </div>
         <!-- end card body -->
